namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class AddnewFieldInTaskTaskDuration : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Tasks", "TaskDuration", c => c.Double());
