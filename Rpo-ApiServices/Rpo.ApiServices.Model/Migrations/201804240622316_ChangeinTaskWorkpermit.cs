namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class ChangeinTaskWorkpermit : DbMigration
    {
        public override void Up()
        {
            //DropForeignKey("dbo.Tasks", "IdWorkPermitType", "dbo.JobApplicationWorkPermitTypes");
            //DropIndex("dbo.Tasks", new[] { "IdWorkPermitType" });
            //DropColumn("dbo.Tasks", "IdWorkPermitType");
            //AddColumn("dbo.Tasks", "IdWorkPermitType", c => c.String());
        ...
        {
        //    DropColumn("dbo.Tasks", "IdWorkPermitType");
        //    AddColumn("dbo.Tasks", "IdWorkPermitType", c => c.Int());
        //    CreateIndex("dbo.Tasks", "IdWorkPermitType");
        //    AddForeignKey("dbo.Tasks", "IdWorkPermitType", "dbo.JobApplicationWorkPermitTypes", "Id");
