namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class IdSignature : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Rfps", "IdSignature", c => c.String());
                ...
                p => new
                    {
                        ...
                        SpecialPlace = p.String(maxLength: 100),
        ...
        {
            DropColumn("dbo.Rfps", "IdSignature");
