namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class ExportGrants : DbMigration
    {
            ...
            AlterStoredProcedure(
                ...
                body:
                    @"INSERT [dbo].[Groups]([Name], [Description], [EmployeeEmployeeInfo], [EmployeeContactInfo], [EmployeePersonalInfo], [EmployeeAgentCertificates], [EmployeeSystemAccessInformation], [EmployeeUserGroup], [EmployeeDocuments], [EmployeeStatus], [Jobs], [Contacts], [ContactsExport], [Company], [CompanyExport], [RFP], [Tasks], [Reports], [ReferenceLinks], [ReferenceDocuments], [UserGroup], [Masters], [IsActive])
                      VALUES (@Name, @Description, @EmployeeEmployeeInfo, @EmployeeContactInfo, @EmployeePersonalInfo, @EmployeeAgentCertificates, @EmployeeSystemAccessInformation, @EmployeeUserGroup, @EmployeeDocuments, @EmployeeStatus, @Jobs, @Contacts, @ContactsExport, @Company, @CompanyExport, @RFP, @Tasks, @Reports, @ReferenceLinks, @ReferenceDocuments, @UserGroup, @Masters, @IsActive)
