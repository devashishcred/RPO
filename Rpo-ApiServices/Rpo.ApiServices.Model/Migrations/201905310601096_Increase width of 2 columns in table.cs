namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class Increasewidthof2columnsintable : DbMigration
    {
        public override void Up()
        {
            AlterColumn("dbo.RfpAddresses", "SpecialDistrict", c => c.String());
            AlterColumn("dbo.JobHistories", "Description", c => c.String());
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.RfpAddresses", "SpecialDistrict", c => c.String(maxLength: 50));
