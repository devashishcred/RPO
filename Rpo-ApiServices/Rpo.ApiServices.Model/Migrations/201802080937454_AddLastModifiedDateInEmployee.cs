namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class AddLastModifiedDateInEmployee : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Employees", "CreatedBy", c => c.Int());
            AddColumn("dbo.Employees", "CreatedDate", c => c.DateTime(nullable: true));
            CreateIndex("dbo.Employees", "CreatedBy");
            AddForeignKey("dbo.Employees", "CreatedBy", "dbo.Employees", "Id");
        ...
        {
            DropForeignKey("dbo.Employees", "CreatedBy", "dbo.Employees");
