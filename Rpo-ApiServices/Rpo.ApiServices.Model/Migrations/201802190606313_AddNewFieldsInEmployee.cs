namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class AddNewFieldsInEmployee : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Employees", "EmergencyContactName", c => c.String(maxLength: 50));
            AddColumn("dbo.Employees", "EmergencyContactNumber", c => c.String(maxLength: 25));
            AddColumn("dbo.Employees", "LockScreenPassword", c => c.String(maxLength: 25));
            AddColumn("dbo.Employees", "AppleId", c => c.String(maxLength: 50));
            AddColumn("dbo.Employees", "ApplePassword", c => c.String(maxLength: 25));
        ...
        {
            DropColumn("dbo.Employees", "ApplePassword");
            DropColumn("dbo.Employees", "AppleId");
            DropColumn("dbo.Employees", "LockScreenPassword");
            DropColumn("dbo.Employees", "EmergencyContactNumber");
