namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class AddTaskNumberInTask : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Tasks", "TaskNumber", c => c.String());
            AlterStoredProcedure(
                ...
                body:
                    @"INSERT [dbo].[Tasks]([AssignedDate], [IdAssignedTo], [IdAssignedBy], [IdTaskType], [CompleteBy], [IdTaskStatus], [GeneralNotes], [IdJobApplication], [IdWorkPermitType], [IdJob], [IdRfp], [IdContact], [IdCompany], [LastModifiedDate], [ClosedDate], [LastModifiedBy], [IdExaminer], [CreatedBy], [CreatedDate], [TaskNumber])
                      VALUES (@AssignedDate, @IdAssignedTo, @IdAssignedBy, @IdTaskType, @CompleteBy, @IdTaskStatus, @GeneralNotes, @IdJobApplication, @IdWorkPermitType, @IdJob, @IdRfp, @IdContact, @IdCompany, @LastModifiedDate, @ClosedDate, @LastModifiedBy, @IdExaminer, @CreatedBy, @CreatedDate, @TaskNumber)
        ...
        {
            DropColumn("dbo.Tasks", "TaskNumber");
