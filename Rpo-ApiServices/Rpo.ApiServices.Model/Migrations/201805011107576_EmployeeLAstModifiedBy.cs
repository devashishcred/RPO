namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class EmployeeLAstModifiedBy : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Employees", "LastModifiedBy", c => c.Int());
           ...
           // AddForeignKey("dbo.Employees", "LastModifiedBy", "dbo.Employees", "Id");
            AlterStoredProcedure(
                ...
                body:
                    @"INSERT [dbo].[Employees]([FirstName], [LastName], [Address1], [Address2], [City], [IdState], [ZipCode], [WorkPhone], [WorkPhoneExt], [MobilePhone], [HomePhone], [Email], [Ssn], [Dob], [StartDate], [FinalDate], [Notes], [TelephonePassword], [ComputerPassword], [EfillingPassword], [EfillingUserName], [IdGroup], [Permissions], [IsActive], [LoginPassword], [CreatedBy], [CreatedDate], [EmergencyContactName], [EmergencyContactNumber], [LockScreenPassword], [AppleId], [ApplePassword], [IsArchive], [LastModifiedBy], [LastModifiedDate])
