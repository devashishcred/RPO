namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class RpfOnJob : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Jobs", "IdRfp", c => c.Int());
            CreateIndex("dbo.Jobs", "IdRfp");
            AddForeignKey("dbo.Jobs", "IdRfp", "dbo.Rfps", "Id");
        ...
        {
            DropForeignKey("dbo.Jobs", "IdRfp", "dbo.Rfps");
            DropIndex("dbo.Jobs", new[] { "IdRfp" });
            DropColumn("dbo.Jobs", "IdRfp");
