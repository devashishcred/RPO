namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class BoroughRfpAddress : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.RfpAddresses", "IdBorough", c => c.Int(nullable: false));
            AddColumn("dbo.RfpAddresses", "Borough_Id", c => c.Int());
            CreateIndex("dbo.RfpAddresses", "Borough_Id");
            AddForeignKey("dbo.RfpAddresses", "Borough_Id", "dbo.Boroughs", "Id");
            ...
            AlterStoredProcedure(
                ...
                body:
                    @"DELETE [dbo].[RfpAddresses]
                      WHERE (([Id] = @Id) AND (([Borough_Id] = @Borough_Id) OR ([Borough_Id] IS NULL AND @Borough_Id IS NULL)))"
            );
        ...
        {
            DropForeignKey("dbo.RfpAddresses", "Borough_Id", "dbo.Boroughs");
            DropIndex("dbo.RfpAddresses", new[] { "Borough_Id" });
            DropColumn("dbo.RfpAddresses", "Borough_Id");
