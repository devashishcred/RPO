namespace Rpo.ApiServices.Model.Migrations
{
    ...
    public partial class AllergyInEmployee : DbMigration
    {
        public override void Up()
        {
            AddColumn("dbo.Employees", "AllergyType", c => c.Int());
            AddColumn("dbo.Employees", "AllergyDescription", c => c.String());
                ...
                p => new
                    {
                        ...
                        AllergyType = p.Int(),
                        AllergyDescription = p.String(),
                    },
                body:
                    @"INSERT [dbo].[Employees]([FirstName], [LastName], [Address1], [Address2], [City], [IdState], [ZipCode], [WorkPhone], [WorkPhoneExt], [MobilePhone], [HomePhone], [Email], [Ssn], [Dob], [StartDate], [FinalDate], [Notes], [TelephonePassword], [ComputerPassword], [EfillingPassword], [EfillingUserName], [IdGroup], [Permissions], [IsActive], [LoginPassword], [CreatedBy], [CreatedDate], [EmergencyContactName], [EmergencyContactNumber], [LockScreenPassword], [AppleId], [ApplePassword], [IsArchive], [LastModifiedBy], [LastModifiedDate], [QBEmployeeName], [AllergyType], [AllergyDescription])
        ...
        {
            DropColumn("dbo.Employees", "AllergyDescription");
            DropColumn("dbo.Employees", "AllergyType");
