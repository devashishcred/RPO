...
// ***********************************************************************
// <copyright file="TaskType.cs" company="CREDENCYS">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace Rpo.ApiServices.Model.Models
{
    ...
    public class TaskType
    {
        ...
        [Index("IX_TaskTypeName", IsUnique = true)]
        [Required]
        ...
        public bool IsDisplayTime { get; set; } = false;

        public bool IsDisplayContact { get; set; } = false;

        public bool IsDisplayDuration { get; set; } = false;

        public int? IdDefaultContact { get; set; }

        [ForeignKey("IdDefaultContact")]
