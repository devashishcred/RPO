...
// ***********************************************************************
// <copyright file="ContactLicenseType.cs" company="CREDENCYS">
//     Copyright ©  2017
// </copyright>
// <summary>Class Contact License Type.</summary>
// ***********************************************************************
...
namespace Rpo.ApiServices.Model.Models
{
    ...
    /// <summary>
    /// Class Contact License Type.
    /// </summary>
    public class ContactLicenseType
    {
        /// <summary>
        ...
        [Index("IX_ContactLicenseTypeName", IsUnique = true)]
        [Required]
        [MaxLength(50)]
