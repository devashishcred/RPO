...
namespace Rpo.ApiServices.Api.Controllers.Dashboards
{
    ...
    [Authorize]
    public class DashboardTasksAssignedByYouController : ApiController
    {
        private RpoContext rpoContext = new RpoContext();

        /// Get the TasksAssignedByYou
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>IHttpActionResult. Get the deshboard TasksAssignedByYou current week </returns>
        [ResponseType(typeof(DataTableResponse))]
        [Authorize]
        [RpoAuthorize]
        //[Route("api/Dashboards/TasksAssignedByYou")]
        public IHttpActionResult GetDashboardTasksAssignedByYou([FromUri] DataTableParameters dataTableParameters)
        {
            ...
            //{
                ...
                DateTime completedFromDate = DateTime.UtcNow;
                DateTime completedToDate = DateTime.UtcNow.AddDays(5);
                ...
                IQueryable<Task> tasks = rpoContext.Tasks
                                            ...
                                            .Include("LastModified").Where(x => x.IdAssignedBy == employee.Id
