...
namespace Rpo.ApiServices.Api.Controllers.Dashboards
{
    ...
    [Authorize]
    public class DashboardTasksAssignedToYouController : ApiController
    {
        private RpoContext rpoContext = new RpoContext();


        /// Get the TasksAssignedToYou
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <returns>IHttpActionResult. Get the deshboard TasksAssignedToYou current week </returns>
        [ResponseType(typeof(DataTableResponse))]
        [Authorize]
        [RpoAuthorize]
        public IHttpActionResult GetDashboardTasksAssignedToYou([FromUri] DataTableParameters dataTableParameters)
        {
            ...
            //{
                ...
                IQueryable<Task> tasks = rpoContext.Tasks
                                            ...
                                            .Include("LastModified").Where(x => x.IdAssignedTo == employee.Id
