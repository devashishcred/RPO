...
// ***********************************************************************
// <copyright file="DOHMHCoolingTowerPenaltyScheduleDetail.cs" company="CREDENCYS">
//     Copyright ©  2017
// </copyright>
...
namespace Rpo.ApiServices.Api.Controllers.DOHMHCoolingTowerPenaltySchedules
{
    ...
    /// </summary>
    public class DOHMHCoolingTowerPenaltyScheduleDetail
    {
        /// <summary>
        ...
        public string FormattedPenaltyFirstViolation { get; set; }

        public double? PenaltyRepeatViolation { get; set; }

        public string FormattedPenaltyRepeatViolation { get; set; }
