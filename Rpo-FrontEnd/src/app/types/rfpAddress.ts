...
import {occupancyClasifications,constructionClassifications,multipleDwellingClassifications,structureOccupancyCategories,primaryStructuralSystems,seismicDesignCategories} from  './classifications';
