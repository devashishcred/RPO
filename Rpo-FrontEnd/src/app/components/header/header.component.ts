...
export class HeaderComponent implements OnInit {
  ...
  private openModalForm(template: TemplateRef<any>, id?: number, from?: string) {
    this.isNew = false
    if (!id) {
      this.isNew = true
    }
  ...
  public openJobProgressionModal() {
    this.modalRef = this.modalService.show(this.jobprogressionnote, { class: 'modal-send-email', backdrop: 'static', 'keyboard': false })
  }
  ...
  public openModalProjectAddress(template: TemplateRef<any>) {
    this.modalRef = this.modalService.show(template, { class: 'modal-new-project-address', backdrop: 'static', 'keyboard': false })
  }
...
*/
  ...
  //   \nProject : ${this.jobDetail.id}
  // `;
    window.location.href = `mailto:${email}?subject=Assitance Needed From Snapcor!&body=${encodeURIComponent(emailBody)}`;
  }
