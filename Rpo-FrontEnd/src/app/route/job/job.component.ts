...
export class JobComponent implements OnInit {
  ...
  private isAddressDisable: boolean = false
  private isReAssign: boolean = false
  ...
  private srch: string
  private showsrch: boolean = false;
  ...
  private isSearchFromAddress: boolean = false
  private flager: boolean = false
  private isSent: boolean = false
  private statusToSet: string = ''
  public data: any = []
  private changeStatusFromReason: any
  private reopen: boolean = false
  private loading: boolean = false
  private from: string = 'JobModule';
  localSearch: boolean;
  ...
  */
   ...
   * @param {number} id ID of Job 
   */
  private openModalForm(template: TemplateRef<any>, id?: number) {
   ...
   */
  private onSave(jobObj: Job, evt: any) {
   ...
   */
  private openAddJobModal(template: TemplateRef<any>, id?: number, isNew?: boolean) {
    if (isNew) {
      this.isAddressDisable = false
      this.isReAssign = false
    }
