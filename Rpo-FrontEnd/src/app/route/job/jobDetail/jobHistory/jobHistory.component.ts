...
export class JobHistoryComponent implements OnInit {
  ...
  private jobHistoryData: any = []
  private selectedEmp:any
  private selectedType: any
  private selectedStartDate: any
  private selectedEndDate: any
  ...
  */
   ...
   */
  private reloadFilter(idJob:number,selectedType:any,selectedEmp:any,selectedStartDate:any,selectedEndDate:any){
   ...
   */
  private openModalFilterHistory(template: TemplateRef<any>, id?: number) {
