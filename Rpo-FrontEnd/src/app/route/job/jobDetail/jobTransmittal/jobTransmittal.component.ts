...
export class JobTransmittalComponent implements OnInit {
  ...
  */
  ...
  private idOldTrasmittal: number
  private tasknumberofTransmittal: any
  private isResend: boolean = false
  private isRevise: boolean = false
  private loading: boolean = false
  private createNewTransmittal: boolean = false
...
*/
  ...
  */
  private openCreateTransmittalModal(template: TemplateRef<any>, action?: string, id?: number, taskdata?: any) {
