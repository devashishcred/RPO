...
export class JobScopeComponent implements OnInit {
  ...
  */
  ...
  private showBtnStatus: string
  private linkedRFPList: any[]
  private proposalIdRfp: number
  private scopeHistoryData: any
  private showScopeAddBtn: string = 'hide'
  private showScopeDeleteBtn: string = 'hide'
  private showScopeNewAddBtn: string = 'hide'
  private showScopeNewDeleteBtn: string = 'hide'
  private showRFPViewBtn: string = 'hide'
  private showMilestoneAddBtn: string = 'hide'
  private sshowMilestoneAddBtn: string = 'hide'
  private showCostColumn: string = 'hide'
  private scopeCostType: number
  ...
  */
   ...
   */
  private downloadRFPProposal(proposalIdRfp: any) {
    if (proposalIdRfp) {
 ...
 */
   ...
   */
  private openAddScopeModalForm(template: TemplateRef<any>, id?: number) {
    this.addJobScope = {} as JobScope;
    this.serviceGroups = [];
    this.modalRef = this.modalService.show(template, { class: 'modal-add-scope', backdrop: 'static', 'keyboard': false })
  }
  private openAddBillingPointForm(template: TemplateRef<any>, MilestoneId?: number) {
  ...
  /**
     ...
     */
  private setSevicesData(id: number) {
    if (id) {
