...
export class JobDetailComponent implements OnInit {
    ...
    private dobApp: boolean = false
    private depApp: boolean = false
    private dotApp: boolean = false
    private isViolation: boolean = false
    private serviceSubscription: any;
    private serviceSubscriptionAppType: any;
    private isCustomerLoggedIn: boolean = false;
    ...
    constructor(
        ...
        if (this.isCustomerLoggedIn && (userRight.checkAllowButton(constantValues.VIEWECBVIOLATION) == 'show' || userRight.checkAllowButton(constantValues.VIEWDOBVIOLATION)== 'show')) {
