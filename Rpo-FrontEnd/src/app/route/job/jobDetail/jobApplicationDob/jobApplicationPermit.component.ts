...
export class JobApplicationPermitComponent implements OnInit {
  ...
  private idJobApp: number
  private appType: any
  private idJobAppPermit: number
  private idApp: number
  private idApplicationNumber: any
  private table: any
  private filter: any = {}
  private searchpermit: any
  private idJob: number
  private isNew: boolean = false
  private showBtnStatus: string = "show"
  private sub: any
  private id: number
  private isAppData: Boolean = false
  ...
  //Job Add Application
  private showJobApplicationAddBtn: string = 'hide'
  ...
  */
   ...
   */
  private updatePermits(permit: any) {
    this.reload();
   ...
   * @param {string} searchpermit Search Criteria 
   */
  private searchPermit(searchpermit: string) {
   ...
   */
  private openModalFormAddPermit(template: TemplateRef<any>, id?: number) {
    if (!id) {
