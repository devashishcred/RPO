...
export class JobViolationComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  private showAddJobViolation: string = 'hide'
  private showDeleteJobViolation: string = 'hide'
  private sub: any
  ...
  public violationType: string = 'AOTH Violation';
  aothColumns = [];
  dobColumns = [];
  ...
  constructor(
    ...
    this.showDeleteJobViolation = this.userRight.checkAllowButton(this.constantValues.DELETEVIOLATION)
  ...
  */
   ...
   */
  private searchStates(srch: string) {
