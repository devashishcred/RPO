...
export class EmailtypeformComponent implements OnInit {
  ...
  private showEmailType: boolean = false
    ...
    if (this.selectedDefaultCC.length > 0) {
      ...
      for (var i = 0; i < this.selectedDefaultCC.length; i++) {
        if (this.selectedDefaultCC[i].idEmployee) {
          this.emailType.defaultCC.push({ "idEmployee": this.selectedDefaultCC[i].idEmployee, "itemName": this.selectedDefaultCC[i].itemName })
        } else {
          this.emailType.defaultCC.push({ "idEmployee": this.selectedDefaultCC[i].id, "itemName": this.selectedDefaultCC[i].itemName })
        }
