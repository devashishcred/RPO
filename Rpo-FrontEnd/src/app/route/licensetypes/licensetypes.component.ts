...
import { LicenseTypesServices } from './licensetypes.services';
...
*/
@Component({
  templateUrl: './licensetypes.component.html',
  styleUrls: ['./licensetypes.component.scss']
})
export class LicenseTypesComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  private LicenseTypesId: number
  private search: string
  private showLincenseTypeAddBtn: string = 'hide'
  ...
  constructor(
    ...
    private LicenseTypesServices: LicenseTypesServices,
  ...
  */
  private searchLicenseTypes(srch: string) {
