...
*/
@Component({
  selector: '[add-License-types]',
  templateUrl: './licensetypesform.component.html',
  styleUrls: ['./licensetypesform.component.scss']
})
export class LicenseTypesForm implements OnInit {
  @Input() isNew: boolean
