...
export class CompanyDetailComponent implements OnInit {
  ...
  */
  ...
  private companyWidgetItems: DropdownWidgetItem[] = [
  ...
  private contactWidgetItems: DropdownWidgetItem[] = [
  ...
  private inActivecontactWidgetItems: DropdownWidgetItem[] = [
    { key: 1, text: 'Edit Contact' },
    { key: 5, text: 'Delete Contact' }
  ]
  ...
  private concreteLabSelected: boolean = false;
  private websiteUrl: boolean = false;
  private jobOfComp: Job
...
*/
   ...
   */
  private onCompanyWidgetItemClick(key: number) {
    if (key == 1) {
   ...
   * @param {number} key flag for different events
   */
  private onContactWidgetItemClick(key: number, contact: Contact) {
    if (key == 1) {
   ...
   */
  private onSave(ctt: any, evt: any) {
    console.log(ctt);
   ...
   */
  private join(arr: string[], s: string = ', '): string {
