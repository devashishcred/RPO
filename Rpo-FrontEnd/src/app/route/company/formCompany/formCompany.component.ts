...
export class FormCompanyComponent implements OnInit {
  ...
  private isTwoTypesSelected: boolean = false
  private dropdownList: CompanyType[] = [];
 ...
 */
  ...
  */
 private editContactLicense(cl: CompanyLicense, idx: number) {
  ...
  */
 private deleteContactLicense(cl: CompanyLicense) {
  ...
  */
  private OnCheckboxSelect(id: number, idParent: number, event: any) {
  ...
  */
 private deleteDocument(d: CompanyDocuments) {
  if (d.id) {
  ...
  */
  private getCompanyInfo(cInfo: any) {
  ...
  */
  private updateFormFieldsFromBIS(res: any) {
    this.gcSubTypes.forEach((data: any) => {
      this.tmpCompanySubTypes[data.id] = {}
