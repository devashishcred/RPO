...
export class GenerteChecklistComponent implements OnInit {
  ...
  private dropdownSettingsFroWorkPermits: any = {};
  private dropdownSettingsForGroup: any = {};
  private dropdownSettingsForFloors: any = {};
  selectGroups: any;
  ...
  private mainChecklistArray: any[] = [];
  ...
  get JobApplicationWorkPermitTypes() { return this.generalChecklistFormData.get('JobApplicationWorkPermitTypes'); }
  get CheckListGroups() { return this.generalChecklistFormData.get('CheckListGroups'); }
  get jobId() { return this.generalChecklistFormData.get('IdJob'); }
  get typedFloor() { return this.generalChecklistFormData.get('typedFloor'); }
  get selectedInspection() { return this.generalChecklistFormData.get('selectedInspection'); }
  ...
  get ParentChecklistheaderId() { return this.compositeChecklistFormData.get('ParentChecklistheaderId'); }
  ...
  */
  ...
  patchGeneralChecklistFormData() {
    ...
    if (this.idChecklist) {
      ...
      this.checklistByIdFormatedData.JobPlumbingCheckListFloors = this.checklistByIdFormatedData.JobPlumbingCheckListFloors.map(v => ({ FloonNumber: v.floonNumber, FloorDisplayOrder: v.floorDisplayOrder, InspectionType: v.inspectionType, Id: v.id }));
