...
export class ContactComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  private showContactExportBtn: string = 'hide'
  ...
  private idCompanyFromContact: number
...
*/
  ...
  * @method onSave
  */
  private onSave(ctt: Contact, evt: any) {
    this.table.clearPipeline()
    this.table.ajax.reload()
  }
  ...
  * @param {number} id it is optional which contains id if record is in edit mode
  */
  private openModalFormAddTask(template: TemplateRef<any>, id?: number, from?: string, contactdata?: any) {
    if (from) {
