...
export class WorkPermitTypeComponent implements OnInit, OnDestroy {
  ...
  private rec: any
  private filter: any
  private workPermitTypeId: number
  private loading: boolean = false
  private showWorkPermitTypeAddBtn: string = 'hide'
  private showWorkPermitTypeDeleteBtn: string = 'hide'
  ...
  */
  private searchWorkPermit(srch: string) {
