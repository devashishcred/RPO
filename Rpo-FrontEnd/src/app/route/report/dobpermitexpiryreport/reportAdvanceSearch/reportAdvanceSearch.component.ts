...
export class PermitReportAdvanceSearchComponent {
  ...
  private dropdownBoroughListSettings: any = {badgeShowLimit: 1,};
  private dropdownResponsibilityListSettings:any ={badgeShowLimit: 1,};
  private loading: boolean = false
  private jobList: any = []
  private projectManagerList: any = []
  private boroughList: any = []
  private respList:any = []
