...
export class EmployeeComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  //Button show hide
  private showEmpAddBtn: string = 'hide'
  private showEmpEditBtn: string = 'hide'
  private showEmpDeleteBtn: string = 'hide'
  private VIEWCONTACTINFO: string;
  private EDITCONTACTINFO: string;
  private VIEWPERSONALINFORMATION: string;
  private EDITPERSONALINFORMATION: string;
  private VIEWAGENTCERTIFICATES: string;
  private EDITAGENTCERTIFICATES: string;
  private VIEWSYSTEMACCESSINFORMATION: string;
  private EDITSYSTEMACCESSINFORMATION: string;
  private VIEWDOCUMENTS: string;
  private EDITDOCUMENTS: string;
  private VIEWEMERGENCYCONTACTINFO: string;
  private EDITEMERGENCYCONTACTINFO: string;
  private VIEWPHONEINFO: string;
  private EDITPHONEINFO: string;
  private EDITSTATUS: string;
  private ViewEmployee: boolean = false;
  ...
  private rec: Employee
  private agentCertificate: AgentCertificate
  private idxAgentCertificate: number = -1

  private table: any
  private specialColumn: any
  private actionRow: any
  private actionFormData: any
  ...
  private groupsDrp: any = [];
  private select2error: boolean = false

  private ssnType: string = 'password'
  private dobType: string = 'password'
  private telephonePasswordType: string = 'password'
  private computerPasswordType: string = 'password'
  private efillingPasswordType: string = 'password'
  private applicationPasswordType: string = 'password'
  private lockScreenPasswordType: string = 'password'
  private applePasswordType: string = 'password'
  private pin: string = 'password'
  ...
  private isRequiredCertificate: boolean = false;
  private isRequiredCertificateId: boolean = false;
  private active: any = {}
  ...
  ngOnInit() {
    ...
    vm.table = $('#dt-employee').DataTable({
      ...
      rowCallback: ((row: any, data: any, index: any) => {
        $(row).find('.delete-icon').hide(); this.showEmpEditBtn
...
*/
  private validatePassword(newPassword: any, confirmPassword: any) {
  ...
  private editPermissions(template: any, apply: boolean = false) {
    if (!apply) {
      this.employeeServices.getById(this.actionRow.data().id).subscribe((r: any) => {
        ...
        this.loading = false;
        this.modalRef = this.modalService.show(template, { class: 'modal-user-group', backdrop: 'static', 'keyboard': false })
      })
    } else {
 ...
 */
  private togglePassword(p: any, obj: any = null) {
    obj = obj || this;
  ...
  */
  private openModal(template: TemplateRef<any>, id?: number) {
  ...
  */
  private editAgentCertificate(a: AgentCertificate, idx: number) {
  ...
  */
  private deleteAgentCertificate(a: AgentCertificate) {
  ...
  */
  private deleteDocument(d: EmployeeDocument) {
    if (d.id) {
