...
export class SiteInformationComponent implements ComponentCanDeactivate {
    ...
    */
    ...
    private modalRefAddress: BsModalRef
    ...
    private rfpAddressList: rfpAddress[] = []
    ...
    private SecondOfficerContact: Contact[] = []
    private rfp: rfp
    private scopeReview: any
    private proposalReview: any
    private occuClassifications: occupancyClasifications[] = []
    private alloccuClassifications: occupancyClasifications[] = []
    private constructionClassifications: constructionClassifications[] = []
    private allConstructionClassifications: constructionClassifications[] = []
    private multipleDwellingClassifications: multipleDwellingClassifications[] = []
    private primaryStructuralSystems: primaryStructuralSystems[] = []
    private structureOccupancyCategories: structureOccupancyCategories[] = []
    private seismicDesignCategories: seismicDesignCategories[] = []
    private rfpAddressdropdownList: any;
    private errorMsg: any
    private slectecontact: number
    private loading: boolean = false
    private showNavigationTabs: boolean = false
    ...
    private displayGetInfo: boolean = false
    ...
    private addresseeContactsList: any
    private receipientContactsList: any
    private referedByContactsList: any
    private addAddContactsList: any
    ...
    private showAddressAddBtn: string = 'hide'
    private documents: any = []
    private ownerTypes: OwnerType[] = []
    private isSecondOfficerRequire: boolean = false;
    setVM(vm1: any) {
    ...
    private isOutsideNYC:boolean =false
    ...
    */
     ...
     */
    private checkBisAddressInfo(formChanged: string) {
    ...
    */
    private updateFormFieldsFromGetInfo(address: any) {
    ...
    */
     ...
     */
    private receiveJobId(jobObj: Job) {
        this.rfpAddressdropdownList = [];
  ...
  * @method getContacts
  */
    private getContactsFor2ndOfficer() {
    ...
    *
    */
    private getContactsFromCompany(companyId?: number, forContact?: string, isAddressFromCmp?: boolean, currentVM?: any) {
  ...
  */
    ...
    */
    private viewAddressModal(template: TemplateRef<any>, id?: number) {
        this.modalRef = this.modalService.show(template, { class: 'modal-new-address', backdrop: 'static', 'keyboard': false })
    }
     ...
     */
    private saveStep1SiteInfo(isSaveAndExit?: boolean, stepName?: string) {
        this.formNotChanged = true
        this.loading = true
