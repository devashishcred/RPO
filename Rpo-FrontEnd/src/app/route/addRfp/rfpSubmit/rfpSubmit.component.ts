...
export class rfpSubmitComponent {
    ...
    private modalRefJob: BsModalRef
    private modalRefFee: BsModalRef
    ...
    private jobObj: Job
    private rfpStatusList: any = []
    private rfpDetail: any = {}
    private createdBy: string
    private modifiedBy: string
    private addRfpProgressionNote: any
    private exsitingNotes: any = []
    private isNewGenrealNote: boolean = false
    private linkTobeJobs: any = []
    private isTobeLinkJobId: string = "disabled";
    private linkJobId: string
    private poNumber: string
    private from: string
    private alreadyRFPLinkedWithJob: boolean = false;
    private alreadyLinkedJobId: number;
    private createdJobId: number;
    static newVM: any;
    //Job show hide
    ...
    private showDisable: boolean = false;
  ...
  /**
      ...
      * @method diLinkJob
      */
    private diLinkJob(poId){
    //     this.appComponent.showDeleteConfirmation(this.delete, ['D_LINK'])
    //    console.log("po",this.linkJobId);
    this.loading = true;
    let requestObj = { IdRfp: this.id.toString(), IdJob: this.alreadyLinkedJobId, PONumber: '' , JobNumber:this.alreadyLinkedJobId};
  ...
  */
   ...
   */
    ...
    */
    private setCommonJobData(idJob: number) {
   ...
   */
    private alreadyGetLinkedJob(fromJob?: boolean) {
        if (fromJob) {
   ...
   */
    private openModalFeeSchedule(template: TemplateRef<any>) {
        this.modalRefFee = this.modalService.show(template, { class: 'modal-fee-schedule', backdrop: 'static', 'keyboard': false })
    }
