...
export class proposalReviewComponent implements ComponentCanDeactivate {
    ...
    */
    ...
    private exsitingProposal: any = [];
    private finalProposal: any = [];
    private dp: any = [];
    private requestData: any = [];
    private milestoneCost: number;
    private services: any[] = []
    private dropdownSettings: any = {};
    private tmpServicesId: any[] = []
    private autoCalculatedCost: number
    private showReviewBtn: boolean = false
    private costClass: string = 'cost-same'
    ...
    private introduction: number
    private introductionItems: any = []
    private sign: number
    private signItems: any = []
    private signatoryItems: any = [
        { id: "17", name: "Michael Pressel" },
        { id: "18", name: "Robert Anic" },
        { id: "19", name: "Kevin Danielson" }
    ]
    private additionalScope: number
    private additionalScopeItems: any = []
    private conclusion: number
    private conclusionItems: any = []
    private disabledBtn: boolean = false
    private pendingMilestoneCost: number
    private totalMileStoneCost: number
    signatory: any;
