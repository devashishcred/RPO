...
export class projectDetailsComponent implements ComponentCanDeactivate {
    ...
    */
     ...
     * @method addJobType
     */
    private addJobType(idsJobtype?: any, indexofarray?: any) {
     ...
     */
    private setJobSubType(idSubTypeCat: number, item: any, j?:any) {
        item.workType = [];
     ...
     * @param {any} item current row
     */
    private setWorkTypes(idSubType: number, item: any) {
        this.loading = true;
        item.serviceWorkTypes = [];
        if (idSubType) {
     ...
     */
    private saveProjectDetail(isSaveAndExit: boolean, stepName: string) {
     ...
     */
    private removeProjectDetail(idJobType: number, itemId: number, index?: number) {
