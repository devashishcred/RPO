...
export class FormWorkType implements OnInit {
  ...
  private subJobTypesCategory: any
  private subJobTypes: any
  private workTypesCategory: any
  private workType: any
  private costTypeListing: any = []
  private partOfListing: any = []
  private showAdditionalCost: boolean = false
  private showCostRange: boolean = false
  private costRange: any
  private range: any
  private rangeLength: number
  private totalCum: number = 0

  private cumulativeLenght: number
  private showCumulative: boolean = false
  private showServiceInHrs: boolean = false
  private showCostType: boolean = false
  private costNull: boolean = false
