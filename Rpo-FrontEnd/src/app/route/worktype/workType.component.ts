...
export class WorkTypeComponent implements OnInit {
  ...
  */
  ...
  private idRfpWorkType: number
  private showServiceAddBtn: string = 'hide'
  private showServiceDeleteBtn: string = 'hide'
  private showServiceViewBtn: string = 'hide'
...
*/
  ...
  */
  private searchWorkType(srch: string) {
