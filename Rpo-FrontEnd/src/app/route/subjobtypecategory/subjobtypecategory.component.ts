...
export class SubJobTypeCategoryComponent implements OnInit {
  ...
  */
  ...
  private subJobTypeCategoryId: any

  private showSubJobTypeCategoryAddBtn: string = 'hide'
  private showSubJobTypeCategoryViewBtn: string = 'hide'
  private showSubJobTypeCategoryDeleteBtn: string = 'hide'
