...
export class ChecklistItemMasterFormComponent implements OnInit {
  ...
  private listOfWorkpermit: any = []
  private internalReferenceDocuments: any = []
  private id: number
